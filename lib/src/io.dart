...
bool entryExists(String path) => true;
...
bool linkExists(String link) => true; //new Link(link).existsSync();
...
bool fileExists(String file) => true; //new File(file).existsSync();
...
bool dirExists(String dir) => true; //new Directory(dir).existsSync();
...
/// source repository.
bool get runningFromSdk => true; // Platform.script.path.endsWith('.snapshot');
...
Future flushThenExit(int status) => null;
...
Future<PubProcess> startProcess(String executable, List<String> args,
    {workingDir, Map<String, String> environment}) => null;
